...
# 🔊 Динамики для ReSpeaker 2-Mic HAT

![Speakers](doc/img/speakers.jpg)

## 📖 Описание
Пара компактных динамиков, совместимых с ReSpeaker 2-Mic HAT (Seeed Studio).  
Используются в проекте хексапода для воспроизведения звуков и голосовых уведомлений.
...
- Сопротивление: 4 Ω  
- Мощность: 3 Вт  
- Подключение: JST-разъём (совместим с ReSpeaker 2-Mic HAT)  

---

## 🤖 Роль в роботе
- Воспроизведение голосовых сообщений и уведомлений  
